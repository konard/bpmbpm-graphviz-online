...
2. в папке ver1 сохрани код в index.html, реализующий graphviz online, но при обеспечении условия, указанного выше (graphviz online + URL + image). Приведи тестовый пример (dot - код приведи в отдельном файле).  
Требования см. в
